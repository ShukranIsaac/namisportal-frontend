...
import { Elevation, Button, Card, Callout, Code, Intent, Switch, } from "@blueprintjs/core";
    ...
    return (
      ...
      <div style={containerStyle}>
        <Flex 
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4 ><a className="heading" href="#">Licensing</a></h4>
            <p>
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4><a className="heading" href="#">Financing</a></h4>
            <p>
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4><a className="heading" href="#">Library</a></h4>
            <p>
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4><a className="heading" href="#">GIS</a></h4>
            <p>
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4><a className="heading" href="#">TASF</a></h4>
            <p>
          ...
          <Box w={1/3} p={1}>
          <Card elevation={Elevation.TWO}>
            <h4><a className="heading" href="#">Directory</a></h4>
            <p>
